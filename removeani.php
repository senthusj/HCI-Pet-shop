...
<div class="content">
	<div class="form1">
	<form method="post" action="removeani.php">
	
	<lable>Product/Animal Id</lable><br>
<br>
	<input type="text" name="id" placeholder="enter Product/Animal id...."required>
	<input type="submit" name="btnSubmit" value="Remove"></br>
